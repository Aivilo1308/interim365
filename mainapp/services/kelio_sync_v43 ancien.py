    ...
    def synchroniser_absences_kelio(self, date_debut=None, date_fin=None):
        ...
        try:
            ...
            if not date_fin:
                ...
                logger.info(f"[ABSENCES-SYNC] Date fin par défaut: {date_fin}")
            ...
            try:
                ...
                try:
                    ...
                    response = client.service.exportAbsenceRequests(
                        ...
                        calculationMode=1  # 0 = Réalisé, 1 = Planifié (prévisionnel)
                    )
                except TypeError:
                    # Si le paramètre calculationMode n'est pas accepté, appel sans
                    logger.info("[ABSENCES-SYNC] Appel sans paramètre calculationMode...")
                    response = client.service.exportAbsenceRequests(
                        populationFilter='',
                        groupFilter='',
                        startDate=start_date_str,
