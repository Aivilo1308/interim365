...
def update_kelio_service_with_discovery(kelio_service):
    ...
    try:
        ...
        username = kelio_service.config.username or ''
        password = kelio_service.config.get_password() or ''
...
def test_kelio_discovery():
    ...
    """
    base_url = KELIO_BASE_URL
    username = KELIO_DEFAULT_AUTH['username']
    password = KELIO_DEFAULT_AUTH['password']
